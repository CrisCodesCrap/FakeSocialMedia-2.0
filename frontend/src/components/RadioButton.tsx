...
export default function RadioButton({name,clickColor,color,chosenButton, setChosenButton}:RadioButtonProps) {
    ...
    return ( 
        <div style={{background:chosenButton===name?'#6b7280':undefined}} onClick={()=>setChosenButton(name)} className="select-none text-white font-semibold m-2 w-48 h-12 bg-blue-500 rounded-md cursor-pointer duration-200 flex items-center justify-start">
